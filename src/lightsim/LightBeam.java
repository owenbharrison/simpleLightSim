...
public class LightBeam {
  ...
  public void update(ArrayList<Mirror> ms) {
  	...
  	if(intersectPoint!=null) {
  		Vec2D reflected = Vec2D.add(Vec2D.mult(mirrorToReflect.newReflect(rays.get(rays.size()-1).start, intersectPoint), Main.MAX_RAY_SIZE), intersectPoint);
